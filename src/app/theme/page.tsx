        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-xl border border-border bg-card px-5 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="text-xs bg-primary text-primary-foreground rounded-full px-3 py-1.5 font-semibold">Book Free Demo</button>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-brand-gradient p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="flex gap-3">
              <button className="bg-primary text-primary-foreground font-semibold rounded-full px-5 py-2.5 text-sm inline-flex items-center gap-2">Book Free Demo <ArrowRight className="w-4 h-4" /></button>
