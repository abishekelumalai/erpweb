...
const features: FeatureItem[] = [
  ...
  { icon: <GraduationCap className="w-6 h-6" />, label: 'Student Management', desc: 'Manage complete student profiles, academic records and essential information from one centralized school management system.', slug: 'student-management', color: 'from-[#f59e0b] to-[#d97706]', accent: AMBER, tag: null, categories: ['Academics'] },
  ...
  { icon: <MessageCircle className="w-6 h-6" />, label: 'Communication Management', desc: 'Keep parents, teachers and students connected through WhatsApp, SMS, voice broadcasts and school notifications.', slug: 'communication', color: 'from-[#f59e0b] to-[#d97706]', accent: AMBER, tag: null, categories: ['Communication'] },
  { icon: <Package className="w-6 h-6" />, label: 'Academic Inventory Tracking', desc: 'Track academic assets, equipment and inventory in real time with centralized stock management.', slug: 'academic-inventory-management', color: 'from-[#026dde] to-[#024fb3]', accent: BLUE, tag: 'Add-on', categories: ['Add-ons', 'Analytics'] },
  { icon: <Wallet className="w-6 h-6" />, label: 'Payroll Management', desc: 'Simplify salary processing, staff payroll and compliance-related workflows through one integrated system.', slug: 'payroll-management', color: 'from-[#f59e0b] to-[#d97706]', accent: AMBER, tag: 'Add-on', categories: ['Add-ons'] },
